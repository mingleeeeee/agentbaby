...
contract ProtocolFeePercentagesProvider is
    ...
    SingletonAuthentication
{
    ...
    constructor(
        ...
        IProtocolFeesCollector protocolFeeCollector = vault
    ...
    function registerFeeType(
        ...
        require(
            !_feeTypeData[feeType].registered,
    ...
    function _registerFeeType(
        ...
        require(
            (maximumValue > 0) &&
                (maximumValue <= _MAX_PROTOCOL_FEE_PERCENTAGE),
    ...
    function setFeeTypePercentage(
        ...
        require(
            isValidFeeTypePercentage(feeType, newValue),
    ...
    function getFeeTypePercentage(
        uint256 feeType
    ) external view override withValidFeeType(feeType) returns (uint256) {
        if (feeType == ProtocolFeeType.SWAP) {
    ...
    function getFeeTypeName(
        uint256 feeType
    ) external view override withValidFeeType(feeType) returns (string memory) {
